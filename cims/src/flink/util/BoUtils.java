...
public abstract class BoUtils {
	 ...
	 * @param targetKeyName 目标属性key 从目标列表中元素取key值(如user.code)
	 * @param targetPropertyName 目标属性名称 添加的属性名称(如user.name)
	 * 
	 * @param sourceList 源列表
	 * @param sourceKeyName 源属性key 从源列表中取key值对应的列表元素
	 * @param sourcePropertyName 源属性名称 从源列表元素中取属性值作为目标属性名称的值
	 * 
	 */
	@SuppressWarnings("unchecked")
	public static void addProperty(List targetList, String targetKeyName, String targetPropertyName, 
			List sourceList, String sourceKeyName, String sourcePropertyName) {
