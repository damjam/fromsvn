...
public class TestMsgA2050 {

	public static void main(String[] args) throws Exception{
		testA2050();
	}
	private static void testA2050() throws Exception{
		Map map=HeadReqUtils.encapsulationHeadReqParam();
		
		map.put(MsgField.h_exch_code.getFieldCode(), "A2050");
		map.put(MsgField.aip_no.getFieldCode(), "P089958072");
//		map.put(MsgField.take_month.getFieldCode(), "201305");
		String msg = MsgUtil.buildReqMsg(map, MsgA2050.A2050REQ);
		...
		List<Map<String, MsgField>> bodyMapList = MsgUtil.parseResBodyList(resMsg, MsgA2050.A2050RES);
	}
