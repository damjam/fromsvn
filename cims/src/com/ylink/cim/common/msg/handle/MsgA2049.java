...
public class MsgA2049 extends MsgField {
	...
	public static MsgField[] A2049REQ = { MsgField.start_date, MsgField.end_date, exch_dire, MsgField.aip_no

	};

	public static MsgField[] A2049RES = { MsgField.exch_time, MsgField.aip_no, MsgField.deduct_type, MsgField.exch_bal,
			in_account_flag };
