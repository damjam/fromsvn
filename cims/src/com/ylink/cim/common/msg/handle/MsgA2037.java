...
public class MsgA2037 {
	...
	public static MsgField[] A2037REQ = {
		MsgField.aip_no,
		MsgField.access_way,
	...
	public static MsgField[] A2037RES = {
		MsgField.exch_date,
		serial_no,
		MsgField.aip_no,
		MsgField.account_no,
		MsgField.cust_name,
		MsgField.trade_type,
		MsgField.entr_flow_serial_no,
		access_way,
		MsgField.out_account_no,
		MsgField.in_account_no,
		MsgField.exch_bal,
		MsgField.send_stat,
		MsgField.in_account_flag,
		MsgField.remark,
		MsgField.bk_plat_date,
		MsgField.bk_seq_no,
		MsgField.bk_rsp_code,
		MsgField.bk_rsp_msg,
