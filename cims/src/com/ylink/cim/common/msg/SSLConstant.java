...
public final class SSLConstant
{
	...
	//--------------------------------------------------------------------
	/** 存储服务器证书容器 */
	public static final String CFG_SERVER_KEY_STORE_FILE_PATH       = CommUtil.getConfigByString("SERVER_KEY_STORE_FILE_PATH", "./ssl/server.pfx");
	/** 服务器证书容器密码 */
	public static final String CFG_SERVER_KEY_STORE_PASSWORD        = CommUtil.getConfigByString("SERVER_KEY_STORE_PASSWORD", "123456");
	
	/** 客户端证书 */
	public static final String CFG_CLIENT_PUBLIC_KEY_FILE_PATH      = CommUtil.getConfigByString("CLIENT_PUBLIC_KEY_FILE_PATH", "./ssl/client.crt");
