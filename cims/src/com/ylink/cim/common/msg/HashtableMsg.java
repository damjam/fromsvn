...
public class HashtableMsg
{
	...
	/** 
     * 根据黄金二级系统1.0接口规范，解析相应的字符串，规则：
     * 1、第一级分隔符的第一段代表字段名，字段名称用二级分隔符分隔
     * 2、第一级分隔符的第二段代表实际的值，
     ...
     * @param v_htValue
     * @param v_sOrderInfoMsg 排序格式，格式："字段名1 数据类型[string/number] 排序方式[asc/desc],字段名1 数据类型[string/number] 排序方式[asc/desc]"
     */
