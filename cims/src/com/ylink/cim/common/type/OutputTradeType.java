...
public class OutputTradeType extends AbstractType {
	...
	public static final OutputTradeType REFUND = new OutputTradeType("退押金", "10");
	public static final OutputTradeType ELECTRIC = new OutputTradeType("交电费", "11");
	public static final OutputTradeType SALARY = new OutputTradeType("支付工资", "12");
	public static final OutputTradeType DEVICE = new OutputTradeType("购买器材设备", "13");
	public static final OutputTradeType REPAIR = new OutputTradeType("支付维修费", "14");
