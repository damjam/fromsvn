...
public class AreaCodeType extends AbstractType {
	...
	public static final AreaCodeType INNERMONGOLIA = new AreaCodeType("内蒙古自治区", "150000");
	public static final AreaCodeType LIAONING = new AreaCodeType("辽宁省", "210000");
	public static final AreaCodeType JILIN = new AreaCodeType("吉林省", "220000");
	public static final AreaCodeType HEILONGJIANG = new AreaCodeType("黑龙江省", "230000");
	public static final AreaCodeType SHANGHAI = new AreaCodeType("上海市", "310000");
	public static final AreaCodeType JIANGSU = new AreaCodeType("江苏省", "320000");
	public static final AreaCodeType ZHEJIANG = new AreaCodeType("浙江省", "330000");
	...
	public static final AreaCodeType SHANDONG = new AreaCodeType("山东省", "370000");
	...
	public static final AreaCodeType GUANGDONG = new AreaCodeType("广东省", "440000");
	public static final AreaCodeType SHENZHEN = new AreaCodeType("深圳", "440300");
	public static final AreaCodeType GUANGXI = new AreaCodeType("广西壮族自治区", "450000");
	public static final AreaCodeType HAINAN = new AreaCodeType("海南省", "460000");
	public static final AreaCodeType CHONGQING = new AreaCodeType("重庆市", "500000");
	public static final AreaCodeType SICHUANG = new AreaCodeType("四川省", "510000");
	...
	public static final AreaCodeType NINGXIA = new AreaCodeType("宁夏回族自治区", "640000");
	public static final AreaCodeType XINJIANG = new AreaCodeType("新疆维吾尔自治区", "650000");
