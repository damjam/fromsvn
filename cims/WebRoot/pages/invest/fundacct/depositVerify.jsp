...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<html:form action="investFundAction.do?action=doDeposit" styleId="inputForm" styleClass="validate">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						<caption>${ACT.name}</caption>
						<tr>
							<td width="100" height="30" align="right">资金账户</td>
							<td>
								${investInfoActionForm.acctNo} 可用余额
								${investInfoActionForm.balance}
								<html:hidden property="balance"/>
							</td>
						</tr>
						<tr>
							<td width="100" height="30" align="right">付款账户</td>
							<td>
						...
						<tr>
							<td width="100" height="30" align="right">入金金额</td>
							<td>
