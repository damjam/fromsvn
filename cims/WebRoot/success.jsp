...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="fullwidth">
		...
		<!--版权区域-->
		<div class="bottom">
		    <div style="float:left; padding-left:5px; color:#767676;">建议使用IE7.0版本以上浏览器或者FireFox浏览器+1024分辨率获得最佳操作体验</div><div style="float:right; padding-right:5px;color:#767676;">版权所有&copy;<a href="http://www.szgold.com.cn/" title="访问官方网站" target="_blank" style="color:#767676;">广州银联网络支付有限公司</a> 全国客服热线：4008-333-222</div>
		</div>
	</body>
</html>
