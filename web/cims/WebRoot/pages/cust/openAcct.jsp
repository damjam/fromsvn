...
<f:msg styleClass="msg"/>
	<html:form action="custInfoAction.do?action=verifyMemberInfo" method="post" styleClass="validate">
		<div class="userbox">
			<div>
				<b class="b1"></b>
				<b class="b2"></b>
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					  ...
					  <tr>
					   ...
					   <tr>
						    ...
						    <td>
						    	<html:text property="birthday" maxlength="8" readonly="true" onfocus="WdatePicker({endDate:'%y-%M-01'})" styleId="birthday"/>
						    </td>
					   </tr>
					   <tr>
