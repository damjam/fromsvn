					...
					<div class="contentb">
						...
						<table class="form_grid">
							...
							<tr>
								...
								<td height="30">
									<s:textfield id="name" name="name" maxlength="10"/>
								</td>
								<td height="30" align="right" nowrap="nowrap">
									职位
								</td>
								<td height="30">
									<s:select list="#request.positionTypes" headerKey="" headerValue="---请选择---" listKey="key" listValue="value" name="position"/>
								</td>
							</tr>
							<tr></tr>
							<tr></tr>
						...
						<c:forEach items="${list}" var="element">
							<tr class="shortcut">
								<td align="center" nowrap="nowrap" width="30">
									<input name="radioInfo" type="radio" 
								...
								<td align="center" nowrap="nowrap">
									<f:type className="SexType" value="${element.gender}"/>
								</td>
								<td align="center" nowrap="nowrap">
									${element.tel}
								</td>
