					...
					<table class="form_grid">
					  <caption>${ACT.name}</caption>
					   <tr>
						    ...
						    <td>
						    	<s:textfield name="id" id="id" maxlength="10" readonly="true" class="{required:true}"/>
					   ...
					   <tr>
						    <td class="formlabel">国家</td>
						    <td>
						    	<s:select list="#request.countryTypes" listKey="key" listValue="value" name="country"/>
						    </td>
					   </tr>
				  </table>
				  <div class="btnbox">
