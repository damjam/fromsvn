...
public class ImpIndexType extends AbstractType {
	...
	public static final ImpIndexType NORMAL = new ImpIndexType("“ª∞„", "1");
	public static final ImpIndexType IMP = new ImpIndexType("ΩÙº±", "2");
	public static final ImpIndexType NOT = new ImpIndexType("≤ªΩÙº±", "0");
	...
	public static ImpIndexType valueOf(String value) throws Exception {
		...
		if (null == sysDictType) {
			ExceptionUtils.logException(ImpIndexType.class, "¿‡–Õ¥ÌŒÛ");
		}
		return sysDictType;
	}
