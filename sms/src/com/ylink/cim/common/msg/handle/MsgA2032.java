...
public class MsgA2032 {
	...
	public static MsgField[] A2032REQ = { MsgField.aip_no, MsgField.order_no, MsgField.aip_type, MsgField.plan_stat,
			MsgField.start_date, MsgField.end_date };

	public static MsgField[] A2032RES = { MsgField.order_no, MsgField.aip_no, MsgField.account_no, MsgField.cust_name,
			aip_type, aip_mode, MsgField.aip_amount, MsgField.aip_periods, MsgField.chn_aip_date, MsgField.end_date,
			plan_stat, memo, MsgField.e_term_type, MsgField.e_branch_id, MsgField.e_teller_id, MsgField.e_exch_time,
			MsgField.u_term_type, MsgField.u_teller_id, MsgField.u_oper, MsgField.u_time };
