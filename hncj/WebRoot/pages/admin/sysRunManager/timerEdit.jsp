					...
					<div class="contentb">
						<table class="form_grid">
							...
							<tr>
								...
								<td>
									<s:textfield name="beanName" id="beanName"
										maxlength="20" class="{required:true,letter:true}"></s:textfield>
							...
							<tr>
								...
								<td>
									<s:textfield name="beanNameCh" id="beanNameCh"
										maxlength="20" class="{required:true}"></s:textfield>
							...
							<tr>
								...
								<td>
									<s:textfield name="para1" id="para1" maxlength="20"></s:textfield>
							...
							<tr>
								...
								<td>
									<s:textfield name="para2" id="para2" maxlength="20"></s:textfield>
									<span class="field_tipinfo"></span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<s:textfield name="triggertime" id="triggertime"
										maxlength="6" class="{required:true}"
										onclick="WdatePicker({dateFmt:'HHmmss'})"></s:textfield>
