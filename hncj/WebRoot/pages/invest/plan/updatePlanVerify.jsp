...
<f:msg styleClass="msg"/>
	<html:form action="investPlanAction.do?action=doUpdate" styleId="dataForm" method="post" styleClass="validate">
		<html:hidden property="updateSymbol" value="Y"/>
		<html:hidden property="acctNo" value="${investInfoActionForm.acctNo}"/>
		<html:hidden property="orderNo" value="${investInfoActionForm.orderNo}"/>
