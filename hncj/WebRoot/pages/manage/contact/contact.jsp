...
<f:msg styleClass="msg"/>
	<html:form action="contact.do?action=doEdit" styleId="dataForm" method="post" styleClass="validate">
			...
			<div>
				...
				<div class="contentb">
				  ...
				  <div class="btnbox">
					 ...
					 <input type="button" id="btnReturn" value="取消" onclick="gotoUrl('/contact.do?action=list')"/>
				</div>
				</div>
				<b class="b4"></b>
				<b class="b3"></b>
