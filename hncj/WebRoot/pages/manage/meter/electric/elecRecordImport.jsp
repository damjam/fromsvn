...
<html lang="zh-cn"> 
	...
	<body>
		...
		<div class="userbox">
			...
			<div class="contentb">
				<s:form action="elecRecord.do?action=doImport" id="dataForm" enctype="multipart/form-data" class="validate">
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td>
								...
								<span class="field_tipinfo">请输入用电月份,例如201409-201410</span>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<s:file name="file" id="file" style="width:400px" class="userbox_bt {required:true}"/>
