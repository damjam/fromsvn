...
<f:msg styleClass="msg"/>
	<html:form action="adrentBill.do?action=doAdd" styleId="dataForm" method="post" styleClass="validate">
		<div class="userbox">
			<div>
				<b class="b1"></b>
				<b class="b2"></b>
					...
					<table class="form_grid" width="100%" border="0" cellspacing="3" cellpadding="0">
					  <caption>${ACT.name}</caption>
					   <tr>
						    ...
						    <td>
						    	<html:text property="merchantName"  styleId="merchantName" styleClass="{required:true}" maxlength="25" readonly="true"/>
						    	<html:hidden property="merchantNo" styleId="merchantNo"/>
					   ...
					   <tr>
						    ...
						    <td>
						    <html:text property="position"  styleId="position" styleClass="{required:true}" maxlength="20"/>
						    	<span class="field_tipinfo">不能为空</span>
						    </td>
					   </tr>
					   <tr>
						    ...
						    <td>
						    <html:text property="beginDate"  styleId="beginDate" styleClass="{required:true}" maxlength="8" onfocus="WdatePicker();" readonly="true"/>
						    	<span class="field_tipinfo">不能为空</span>
						    </td>
					   </tr>
					   <tr>
						    ...
						    <td>
						    <html:text property="endDate"  styleId="endDate" styleClass="{required:true}" maxlength="8" onfocus="WdatePicker();" readonly="true"/>
						    	<span class="field_tipinfo">不能为空</span>
						    </td>
					   </tr>
					   <tr>
