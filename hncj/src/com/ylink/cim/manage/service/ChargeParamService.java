...
public interface ChargeParamService {
	...
	void saveParam(ChargeParam chargeParam, UserInfo userInfo)
			throws BizException;

	void updateParam(ChargeParam chargeParam, UserInfo userInfo)
			throws BizException;

	void saveOrUpdateItem(ChargeItem chargeItem, UserInfo userInfo)
			throws BizException;
	...
	void saveParamItem(String id, String[] itemIds, UserInfo userInfo)
			throws BizException;
}
