...
public class MsgUtil {
	...
	/*
	 * public static byte[] stringToBytes(String str) { try { if ((str == null)
	 * || (str.length() <= 0)) { return new byte[0]; } return str.getBytes(); }
	 * catch (Exception e) { } return null; } public static byte[]
	 * stringToBytes(StringBuilder str) { try { if ((str == null) ||
	 * (str.length() <= 0)) { return new byte[0]; } return
