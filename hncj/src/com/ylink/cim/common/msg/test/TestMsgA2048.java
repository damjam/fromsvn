...
public class TestMsgA2048 {

	public static void main(String[] args) throws Exception{
		testA2048();
	}
	private static void testA2048() throws Exception{
...
//		map.put(MsgField.take_month.getFieldCode(), "201305");
		String msg = MsgUtil.buildReqMsg(map, MsgA2048.A2048REQ);
		...
		List<Map<String, MsgField>> bodyMapList = MsgUtil.parseResBodyList(resMsg, MsgA2048.A2048RES);
	}
