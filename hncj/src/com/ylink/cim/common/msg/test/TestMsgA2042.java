...
//		Map<String, MsgField> bodyMap = MsgUtil.parseResBody(resMsg, MsgA2042.A2042RES);
		List<Map<String, MsgField>> bodyMapList = MsgUtil.parseResBodyList(resMsg, MsgA2042.A2042RES);
	}
