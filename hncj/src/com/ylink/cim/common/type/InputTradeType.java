...
public class InputTradeType extends AbstractType {
	...
	public static final InputTradeType DEPOSIT = new InputTradeType("业主充值",
			"02");
	public static final InputTradeType SECURITY = new InputTradeType("收押金",
			"03");
	public static final InputTradeType DECORATE = new InputTradeType("收装修服务费",
			"04");
	public static final InputTradeType PARKING = new InputTradeType("收停车费",
			"05");
	public static final InputTradeType INNER_DEPOSIT = new InputTradeType(
			"内部充值", "06");
	public static final InputTradeType IN_OTHER = new InputTradeType("其他入账",
			"09");
