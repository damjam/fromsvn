...
public class AipFareKind extends AbstractType {
	...
	public static final AipFareKind TRANSACTION_COST = new AipFareKind("交易费用", "1");
	public static final AipFareKind CURRENT_INTEREST_RATES = new AipFareKind("活期利率", "2");
	public static final AipFareKind WAREHOUSING_COSTS = new AipFareKind("仓储费用", "3");
	public static final AipFareKind ACCOUNT_MANAGEMENT_FEES = new AipFareKind("账户管理费", "4");
