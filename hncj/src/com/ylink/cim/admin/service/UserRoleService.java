...
public interface UserRoleService {
	...
	public Paginater getUserRolePageList(UserRole userRole,Pager pager) throws BizException;
	
	public Paginater getWaitAssignRolePageList(String userId,Pager pager) throws BizException;
