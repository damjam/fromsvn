  ...
  $(window).resize(function()
  {
   ...
   $(".has_sub > a").click(function(e){
    ...
    if(menu_li.hasClass("open")){
      ...
      menu_li.find('i').removeClass('fa-chevron-down').addClass('fa-chevron-right');
    }
    else{
      $("#nav > li > ul").slideUp(350);
      $("#nav > li").removeClass("open");
      $("#nav > li").find('i').removeClass('fa-chevron-down').addClass('fa-chevron-right');
      menu_ul.slideDown(350);
      menu_li.addClass("open");
      menu_li.find('i').removeClass('fa-chevron-right').addClass('fa-chevron-down');
    }
  });
