...
public class SymbolType extends AbstractType {
	...
	public static final SymbolType YES = new SymbolType("是", Symbol.YES);
	public static final SymbolType NO = new SymbolType("否", Symbol.NO);
	...
	public static SymbolType valueOf(String value) throws Exception {
		...
		if (null == type) {
			ExceptionUtils.logException(SymbolType.class, "类型错误");
		}
		return type;
	}
