...
public class DepositBillDaoImpl extends BaseDaoImpl implements DepositBillDao {
	...
	public Paginater findPager(Map<String, Object> params, Pager pager) {
		...
		if (StringUtils.isNotEmpty(MapUtils.getString(params,
				"startDepositDate"))) {
			helper.append("and depositDate >= ?", DateUtil.formatDate(MapUtils
					.getString(params, "startDepositDate")));
		}
		if (StringUtils
				.isNotEmpty(MapUtils.getString(params, "endDepositDate"))) {
			helper.append("and depositDate <= ?", DateUtil
					.getDayEndByYYYMMDD(MapUtils.getString(params,
							"endDepositDate")));
		}
		if (StringUtils.isNotEmpty(MapUtils
				.getString(params, "startRefundDate"))) {
			helper.append("and refundDate >= ?", DateUtil.formatDate(MapUtils
					.getString(params, "startRefundDate")));
		}
		if (StringUtils.isNotEmpty(MapUtils.getString(params, "endRefundDate"))) {
			helper.append("and refundDate <= ?", DateUtil
					.getDayEndByYYYMMDD(MapUtils.getString(params,
							"endRefundDate")));
		}
