	...
	<head>
		...
		<script type="text/javascript">
		 	...
		 	function addRow(){
		 		...
		 		rowHtml += '<td align="center"><select name="productNames" style="width: 60px;"><option value="座垫">座垫</option><option value="脚垫">脚垫</option><option value="平板后备箱垫">平板后备箱垫</option><option value="全包围后备箱垫">全包围后备箱垫</option><option value="脚垫+丝圈">脚垫+丝圈</option></td>';
					...
					<table class="form_grid">
					  <caption>${ACT.name}</caption>
					   <tr>
						    ...
						    <td>
						    	<s:textfield name="clientName" id="clientName" maxlength="25" class="{required:true} clientName"/>
