...
public class DeductType extends AbstractType {
	...
	public static final DeductType DEDUCT_TYPE_11 = new DeductType("交易委托流水",
			"11");
	public static final DeductType DEDUCT_TYPE_12 = new DeductType("提金准备金",
			"12");
	public static final DeductType DEDUCT_TYPE_23 = new DeductType("现金赎回划款",
			"23");
	...
	public static final DeductType DEDUCT_TYPE_26 = new DeductType("溢短费返回",
			"26");
	public static final DeductType DEDUCT_TYPE_27 = new DeductType("主动定投划款",
			"27");
