...
public class BranchType extends AbstractType {
	...
	public static final BranchType BR_0004 = new BranchType("西班牙玫瑰 ", "0003",
			"xbymg");
	public static final BranchType BR_0005 = new BranchType("欧洲故事", "0004",
			"ozgs");
	public static final BranchType BR_0006 = new BranchType("MOCO新世界 ", "0005",
			"moco");
	public static final BranchType BR_0007 = new BranchType("昌建广场", "0006",
			"cjgc");
	public static final BranchType BR_0008 = new BranchType("格林印象", "0007",
			"glyx");
	public static final BranchType BR_0009 = new BranchType("新旺角", "0008",
			"xwj");
	public static final BranchType BR_0010 = new BranchType("昌建国际", "0009",
			"cjgj");
	public static final BranchType BR_0011 = new BranchType("生态水城 ", "0010",
			"stsc");
