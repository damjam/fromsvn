...
public class MerchantInfoServiceImpl implements MerchantInfoService {
	...
	public void saveOrUpdate(MerchantInfo merchantInfo, UserInfo userInfo) throws BizException {
		String mrname = merchantInfo.getMrname();
		merchantInfo.setFirstLetters(Cn2PinYinHelper.cn2FirstSpell(mrname));
		merchantInfo.setPinyin(Cn2PinYinHelper.cn2Spell(mrname));
